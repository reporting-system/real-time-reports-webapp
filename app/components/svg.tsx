...
export function Light({ className, color, size }: svg_type_props) {
  return (
    <svg
...
export function Dark({ className, color, size }: svg_type_props) {
  return (
    <svg
      data-testid="geist-icon"
      height={size}
...
export function System({ className, color, size }: svg_type_props) {
  return (
    <svg
      data-testid="geist-icon"
      height={size}
